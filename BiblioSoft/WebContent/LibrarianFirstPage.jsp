	...
	<div class="row" style="padding-left: 1%">
			...
			<div class="panel panel-default">
				<div class="panel-heading">
					...
					<div align="center" style="background-color: aliceblue">
						...
						<br>
						<p align="center" style="font-size: 16px; color: #191D30">Biblio's
		...
		<a href="#" style="color:#C8C8C8;padding-right: 10px" ></a>
			...
			<div id="left" class="left">
				...
				<div class="menu-item" href="#one">
					<a href="bookaddselect.jsp" target="mainFrame"
						style="color: #F0F8FF">－Add Book</a>
				</div>

				<div class="menu-item" href="#two">
					<a href="bookdeleteList" target="mainFrame" style="color: #F0F8FF">－Book
				...
				<div class="menu-item" href="#four">
					<a href="borrowedrecordList" target="mainFrame"
						style="color: #F0F8FF"> － Borrowedrecord List</a>
				</div>
			...
			<div class="menu-item" href="#three">
				<a href="LibrarianBorrowBook4.jsp" target="mainFrame"
					style="color: #F0F8FF">－Borrow Book</a>
			</div>

			<div class="menu-item" href="#four">
				<a href="LibrarianReturnBook.jsp" target="mainFrame"
					style="color: #F0F8FF">－Return Book</a>
			</div>
			<br>
		</div>
		...
		<div class="text-center col-md-10" style="background-color: aliceblue">
			<nav class="navbar navbar-expand-lg navbar-dark"
				...
				class="navbar-brand" href="#">BiblioSoft</a>
			...
			<iframe style="width: 90%; height: 80%" src="images/123.png"
				scrolling=no frameborder=0 name="mainFrame" id="mainFrame"
				title="mainFrame"> </iframe>
