...
<% String imagePath = request.getAttribute("imagePath").toString(); %>
	...
	<div style="margin: 0 auto; width: 620px; height: 500px">
		...
		<input type="submit" value="save" name="savebook" id="savebook" style="position:relative;top:-230px">
		<input type="button" value="cancel" name="cancelbook" id="cancelbook" style="position:relative;top:-230px" onclick="location='bookadd2.jsp'">
		</form>
	</div>
</body>
</html>
