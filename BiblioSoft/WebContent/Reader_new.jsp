...
#myborrow tr td:first-child, #myborrow tr td:nth-child(2), #myborrow tr td:nth-child(3),
	#myborrow tr td:nth-child(4), #myborrow tr td:nth-child(5), #myborrow tr td:nth-child(6),
	#myborrow tr td:nth-child(7), #myborrow tr th:first-child, #myborrow tr th:nth-child(2),
	#myborrow tr th:nth-child(3), #myborrow tr th:nth-child(4), #myborrow tr th:nth-child(5),
	#myborrow tr th:nth-child(6), #myborrow tr th:nth-child(7), #myborrow tr td:last-child
	{ /*设置table右边边框*/
	border-right: 2px solid #B0C4DE;
}
...
#myborrow tr td:first-child, #myborrow tr td:nth-child(2), #myborrow tr td:nth-child(3),
	#myborrow tr td:nth-child(4), #myborrow tr td:nth-child(5), #myborrow tr td:nth-child(6),
	#myborrow tr td:nth-child(7), #myborrow tr td:last-child {
	/*设置table表格每列底部边框*/
...
#myhistory tr td:first-child, #myhistory tr td:nth-child(2), #myhistory tr td:nth-child(3),
	#myhistory tr td:nth-child(4), #myhistory tr td:nth-child(5),
	#myhistory tr td:nth-child(6), #myhistory tr th:first-child, #myhistory tr th:nth-child(2),
	#myhistory tr th:nth-child(3), #myhistory tr th:nth-child(4),
	#myhistory tr th:nth-child(5), #myhistory tr th:nth-child(6),
...
#myhistory tr td:first-child, #myhistory tr td:nth-child(2), #myhistory tr td:nth-child(3),
	#myhistory tr td:nth-child(4), #myhistory tr td:nth-child(5),
	#myhistory tr td:nth-child(6), #myhistory tr td:last-child {
	/*设置table表格每列底部边框*/
	border-bottom: 2px solid #B0C4DE;
}
/*table tr:last-child td:first-child,
...
<body>
	<div class="wrap">
		...
		<div id="left" class="left">
			...
			<!-- hou -->
			<div class="menu-item" data-toggle="collapse"
				data-target="#borrowcoll" onmouseover="mouseover('borrow')"
				onmouseout="mouseout('borrow')" id="borrow"
				style="font-weight: bold; color: #707983;">- Borrow And Order</div>
			<div id="borrowcoll" class="collapse"
				style="background-color: #666666">
				<div class="menu-item" href="#jieyue" data-toggle="tab"
					onmouseover="mouseover('myborrowlist')"
					onmouseout="mouseout('myborrowlist')" id="myborrowlist">
					&nbsp;&nbsp;MyBorrowList</div>
				<div class="menu-item" href="#lishi" data-toggle="tab"
					onmouseover="mouseover('historylist');"
					onmouseout="mouseout('historylist')" id="historylist">
					&nbsp;&nbsp;HistoryList</div>
			</div>
			<!-- diao -->
			<div class="menu-item" data-toggle="collapse"
				data-target="#ordercoll" onmouseover="mouseover('my_order')"
				onmouseout="mouseout('my_order')" id="my_order"
				style="font-weight: bold; color: #707983;">- MyOrder</div>
			<div id="ordercoll" class="collapse"
				style="background-color: #666666">
				<div class="menu-item" href="#myorder" data-toggle="tab"
					onmouseover="mouseover('orderlist')"
					onmouseout="mouseout('orderlist')" id="orderlist">
					&nbsp;&nbsp;OrderList</div>
				<div class="menu-item" href="#addorder" data-toggle="tab"
					onmouseover="mouseover('add_order');"
					onmouseout="mouseout('add_order')" id="add_order">
					&nbsp;&nbsp;AddOrder</div>
			</div>
			<!-- xiang -->
			<div class="menu-item" data-toggle="collapse"
				data-target="#informationcoll"
				onmouseover="mouseover('information')"
				onmouseout="mouseout('information')" id="information"
				style="font-weight: bold; color: #707983;">-
				PersonalInformation</div>
			<div id="informationcoll" class="collapse"
				style="background-color: #666666">
				<div class="menu-item" href="#pm-container" data-toggle="tab"
					onmouseover="mouseover('baseinformation')"
					onmouseout="mouseout('baseinformation')" id="baseinformation">
					&nbsp;&nbsp;Modiy PersonalInformation</div>
				<div class="menu-item" href="#ps-container" data-toggle="tab"
					onmouseover="mouseover('safeinformation');"
					onmouseout="mouseout('safeinformation')" id="safeinformation">
					&nbsp;&nbsp;Change Password&Safe</div>
			</div>
		...
		<div id="right" class="tab-content right">
			<div id="one" class="tab-pane active">
				<span
					style="margin-left: 40px; text-shadow: 2px 0px 6px rgba(94, 35, 255, 0.91);">
					<font size="10">Welcome to the page of
						Reader,${Reader.getAccount() }.</font>
				</span>
			</div>
			<!-- xiang -->
			<div id="pm-container" class="tab-pane">
				...
				<div id="pm-imformation">
					<p>
						Account:<input id="accountInput" class="form-control"
							value="${reader.account}" readonly>
					</p>
					<p>
						Eamil:<input id="emailInput" class="form-control"
							value="${reader.email}">
					</p>
					<p>
						Phone:<input id="phoneInput" class="form-control"
							value="${reader.phone}">
					</p>
					<p>
						Fine:<input id="fineInput" class="form-control"
							value="${reader.fine}" readonly>
					</p>
					<p>
						BorrowedNum:<input id="borrowedNumInput" class="form-control"
							value="${reader.borrowedNum}" readonly>
					</p>
					<p>
						CashPledge:<input id="cashPledgeInput" class="form-control"
							value="${reader.cashPledge}" readonly>
					</p>
					</br>
					<button id="modify" class="btn btn-primary btn_search"
						onclick="modifyImformation()">modify</button>
			...
			<div id="ps-container" class="tab-pane">
				...
				<form method="post" action="changePassword">
					<div id="ps-security">
						<p>
							OldPassword: <input id="oldPasswordInput" name="OldPassword"
								class="form-control"
								placeholder="please input your old password" type="password"
								maxlength="16">
						</p>
						</br>
						<p>
							NewPassword: <input id="newPasswordInput" name="NewPassword"
								class="form-control"
			...
			<div class="tab-pane" id="jieyue" style="position: relative">
				<div id=wodejieyue class="table_wrap"
					style="text-align: center; display: block">
					<table id="myborrow" border="1" class="table" cellpadding="5"
						style="margin-left: 5px; margin-right: 30px">
						<caption style="text-align: center">
							<font size="5">Welcome，BorrowList${account}
						</caption>
						<tr>
			...
			<div class="tab-pane" id="lishi" style="position: relative">
				<div id=lishijieyue class="table_wrap"
					style="text-align: center; display: block">
					<table id="myhistory" border="1" class="table" cellpadding="5"
						style="margin-left: 5px; margin-right: 30px">
						<caption style="text-align: center">
							<font size="5">HistoryBorrowedList
						</caption>
						<tr>
							<th style="text-align: center;"><font size="4">No</font></th>
							<th style="text-align: center;"><font size="4">BookID</font></th>
						...
						<c:forEach items="${borrowedRecord}" var="borrowedRecord"
							varStatus="loop">
							<tr>
								<td><font size="4"><p
											id="bRID${borrowedRecord.bRID}">${loop.count}</p></font></td>
			...
			<div id="myorder" class="tab-pane">
				<table id="ordertab" width="100%">
					...
					<c:forEach items="${myorders }" var="myorder" varStatus="mo">
						<p>
							<fmt:formatDate var="hout" value="${myorder.time}" pattern="HHmm" />
						</p>
						<br>
						<tr>
							<th>${mo.index + 1}</th>
							<th>${myorder.bookName }</th>
							<th><fmt:formatDate value="${myorder.time }" type="both"
									dateStyle="medium" timeStyle="medium" /></th>
							<th><fmt:formatDate value="${myorder.time }" type="both"
									dateStyle="medium" timeStyle="medium" /></th>
							<c:choose>
								<c:when
									test="${nowTime-((hout%100)+(hout-(hout)%100)/100*60)>120}">
									<th>超期</th>
								</c:when>
								<c:otherwise>
									<th>未超期</th>
			...
			<div id="addorder" class="tab-pane">
				<form method="POST" action="searchBook">
					<div id="search-container"
						...
						<div id="search-iuput">
							<input id="searchBook" type="text" name="searchou"
								placeholder="please input key words"> <input
								id="search-button" type="submit" name="btn_submit"
								value="search" />
						</div>
				...
				<div id=wodeyuyue class="table_wrap"
					style="text-align: center; display: block">
					<table id="myhistory" border="1" class="table" cellpadding="5"
						style="margin-left: 5px; margin-right: 30px">
						<caption style="text-align: center">
							<font size="5">SearchResult
						</caption>
						<tr>
						...
						<c:forEach items="${bookList}" var="bookList" varStatus="loop">
							<tr>
								...
								<th><a
									href="addOrder?barCode=${bookList.barCode}&bookName=${bookList.bookName}">Add</a></th>
							</tr>
						</c:forEach>
					</table>
				</div>
				<p>barCode</p>
				<input class="form-control" id="barCode_order"
					placeholder="please input barCode" style="width: 300px;">
				<p>bookName</p>
				<input class="form-control" id="bookName_order"
					placeholder="please input bookName" style="width: 300px;"><br />
				<button id="saveorder" class="btn btn-primary btn_search"
					onclick="saveorder()">save</button>
				<button id="cleanorder" class="btn btn-primary btn-info"
					onclick="cleanorder()">clean</button>
			</div>
		</div>
	</div>
</body>
