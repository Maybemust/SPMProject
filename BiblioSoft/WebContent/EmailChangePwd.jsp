...
<body>
						...
						<script type="text/javascript">
							...
							<div id="ps-container" class="tab-pane">
								...
								<div id="ps-security">
									<p>Account:
									<input id="account" name="account" class="form-control" placeholder="please input your account" type="text" readonly="true" maxlength="16" value="${account }">
									</p>
									</br>
									<p>NewPassword:
									<input id="pd" name="pd" class="form-control" placeholder="please input your new password" type="password" maxlength="16">
									</p>
									</br>
									<p>
