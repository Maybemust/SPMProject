...
<!--div class="panel panel-default">
	...
	<script>
		function borrowbook(){
			document.getElementById("EnsureBorrowBooks").submit();
			  ...
			  <div>
				  <row>
				  <form method="post" action="EnsureBorrowBook" id="EnsureBorrowBooks">
				  	...
				  	<br>
					    <button type="submit" class=" btn btn-success btn-lg" data-toggle="modal" data-target="#myModal" >OK</button>
 ...
 <c:if test="${borrownum == 0}">
      <div class="modal-body">
        <h4 style = "color:#002A5A">The account have reached the borrow upper limit!!</h4>
        <h4 style = "color:#002A5A">Cannot borrow new books unless this reader return books!!</h4>
