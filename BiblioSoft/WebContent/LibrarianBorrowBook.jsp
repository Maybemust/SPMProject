...
<div id="left" class="left">
    ...
    <div class="text-center col-md-10" style= "background-color: aliceblue">
       ...
       <div class="collapse navbar-collapse" id="navbarSupportedContent" style="background-color: #002A5A">
          <ul class="navbar-nav ">
             <li class="nav-item active">
                <a class="nav-link" href="#" style="background-color: #002A5A">Home <span class="sr-only">(current)</span></a>
             </li>
             <li class="nav-item">
                <a class="nav-link" href="#"style="background-color: #002A5A">Link1</a>
             </li>
             <li class="nav-item dropdown" style="background-color: #002A5A">
                <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" style="background-color: #002A5A">
                Dropdown
                </a>
                <div class="dropdown-menu" aria-labelledby="navbarDropdown" style="background-color: #002A5A">
                   <a class="dropdown-item" href="#" style="background-color: #002A5A">Action</a>
                   <a class="dropdown-item" href="#" style="background-color: #002A5A">Another action</a>
                   <div class="dropdown-divider"style="background-color: #002A5A"></div>
                   <a class="dropdown-item" href="#" style="background-color: #002A5A">Something else here</a>
                </div>
             </li>
             <li class="nav-item" style="background-color: #002A5A">
                <a class="nav-link disabled" href="#"style="background-color: #002A5A">Disabled</a>
             </li>

          </ul>
		   <ul class="navbar-nav mr-auto" style="background-color: #002A5A">
			  <form class="form-inline my-2 my-lg-0"style = "float :left;" style="background-color: #002A5A">
		    ...
		    <ul class="nav navbar-nav navbar-right" style="background-color: #002A5A">
				<li>"  "</li>
			...
			document.getElementById("borrowbook").submit();
			  ...
			  <div>
				  ...
				  <form method="post" action="borrowBook" id="borrowbook">
				  	...
				  	<br>
					    <button type="button" class=" btn btn-success btn-lg" data-toggle="modal" data-target="#myModal" onclick="borrowbook()">OK</button>
