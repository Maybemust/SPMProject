			...
			<div class="panel panel-primary">
				<div class="panel-heading">
					<h3 class="panel-title" align="left"
						...
						<a>Borrow Book -Ensure Informations</a>
					</h3>
				</div>
		...
		function borrowbook(){
			document.getElementById("borrowbooks").submit();
						...
						<div>
							<row>
							<p
								style="font-size: 20px; color: #191D30; padding-left: 20px; float: left">Book
								name:${borrowbook.getBookName()}</p>
							<br>
							<br>
							<p
								style="font-size: 20px; color: #191D30; padding-left: 20px; float: left">Book
								ID :${borrowbook.getBarCode()}</p>
							<br>
							<br>
							<p
								style="font-size: 20px; color: #191D30; padding-left: 20px; float: left">Book
								ISBN :${borrowbook.getISBN()}</p>
							<br>
							<br>
							<p
							...
							<form method="post" action="borrowBooks" id="borrowbooks">

								<input name="barCode" type="hidden"
									value="${borrowbook.getBarCode()}" class="form-control"
									placeholder="Input Book Id" aria-describedby="sizing-addon1">
								<input name="useraccount" type="hidden"
									value="${borrower.getAccount()}" class="form-control"
									placeholder="Input UserAccount"
									aria-describedby="sizing-addon1"> <br>

								<button type="button" class=" btn btn-warning btn-lg"
									onclick="window.location.href='./LibrarianBorrowBook4.jsp'"
									style="float: left;">Return</button>
									...
									<div class="modal-content">
										...
										<div class="modal-footer">
											...
											<button type="button" class="btn btn-primary"
												onclick="borrowbook()">Submit Now</button>
										</div>
									</div>
								</div>
							</div>
