				  ...
				  <p style = "font-size: 20px;color:#191D30;padding-left: 20px;float:left">Borrower Account :${borrower.getAccount()}</p>
				  	...
				  	<br>
				  						    ...
				  						    <button type="button" class=" btn btn-warning btn-lg"
				  						     onclick = "window.location.href='./LibrarianBorrowBook4.jsp'" style = "float:left;">Return</button>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        ...
        <button type="button" class="btn btn-primary" onclick="borrowbook()">Submit Now</button>
      </div>
    </div>
  </div>
</div>				  	
