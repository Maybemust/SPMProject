		...
		<div class="container-fluid">
			<div class="navbar-header">
				<button type="button" class="navbar-toggle" data-toggle="collapse"
					...
					<span class="sr-only">切换导航下拉键</span> <span class="icon-bar"></span>
		...
		<div class="tab-content" style="width: 100%">
				...
				<div id=wodejieyue class="table_wrap" style="text-align: center;">
					<table id="myborrow" border="1" class="table" cellpadding="5"
						...
						<caption style="text-align: center">
							<font size="5">Welcome，${readeraccount}
						</caption>
						<caption style="text-align: center">
							<font size="4">BorrowList
						</caption>
						<tr>
			...
			<div id=zhinajin class="tab-pane fade">
				...
				<div id="show" class="table_wrap">
					<table id="myborrow" border="1" class="table"
						style="margin: 0 auto">
						<tr>
			...
			<!--xiang-->
			<div class="tab-pane fade" id="myborrowhistory"
				style="position: relative">
